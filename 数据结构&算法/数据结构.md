...
## Trie（字典树，读音同try）
Trie也可以叫做Prefix Tree（`前缀树`），也是一种`搜索树`。

Trie`分步骤存储数据`，树中的每个节点代表一个步骤，trie常用于

存储单词以便快速查找，比如实现`单词的自动完成功能`。

Trie中的每个节点都包含一个单词的字母，跟着树的分支可以可以拼写出
...
![邻接矩阵](https://github.com/LahmYing/front-end-tools/blob/master/%E6%95%B0%E6%8D%AE%E7%BB%93%E6%9E%84%E4%B8%8E%E7%AE%97%E6%B3%95/%E6%95%B0%E6%8D%AE%E7%BB%93%E6%9E%84-%E5%9B%BE.jpg) 
